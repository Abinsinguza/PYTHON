...
Key concepts
Base class(parebt classs): class whose properties are inherited by another class.
...
with open("lasse.txt","w") as file:
    file.write('I am Lasse and I love python.\n')
    file.write('I use python for automation')

#Reading from a text file 

with open('lasse.txt', 'r') as file:
    content = file.read()
    print(content)
...
with open('lasse.csv', 'r') as csv_file:
