...
student_dic['age'] = '31'  
student_dic['tech'] = 'AI, ML, and Data Science'  
print(student_dic)

#Example2 : adding keys and values 
student_dic['email']='lasse@gmail.com'
...
del student_dic['year']

print(student_dic)


#execrise 3.. use the upadate method to update the age 
student_dic.update({'age':'23'})

#Exercise 4: use the if to check if the key 'age' is present 
#in the dictionary

if 'age' in student_dic:
    print(f"The key 'age' is present in the dictionary with the value: {student_dic['age']}")
else:
...
#Exercise 5: use the update method to change the course and add a new key "whatsApp number" to the 
#to the dictionary

student_dic.update({'course': 'BSC', 'WhatsApp': '0704477686'})
